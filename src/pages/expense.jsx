...
const ExpenseTracker = () => {
    const [incomes, setIncomes] = useState([
        ...
        { id: 2, title: "Tution", amount: 5000, date: "1/04/2023", reference: "My January Shopify earnings.", icon: <FaSackDollar className="text-orange-600"/> },
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen">
            <div className="flex-1 p-4 md:p-6">
                <h1 className="text-2xl font-bold text-gray-800 mb-4">Expense</h1>

                {/* Total Expense */}
                <div className="bg-gray-200 p-4 rounded-lg text-xl font-semibold">
                    Total Expense: <span className="text-green-500">${totalIncome}</span>
                </div>
